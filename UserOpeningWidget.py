...
class UserOpeningWidget(QWidget):
    ...
    def __init__(self, application, index, parent=None):
        ...
        self.titleText = 'Пожалуйста, ответьте на следующие\nвопросы для того, чтобы система могла\nопределить, ' \
        ...
        self.continueButtonX, self.continueButtonY = 15, 125
        ...
        self.backButtonX, self.backButtonY = 15, 155
